...
<header class="header">
    ...
    <div class="header-inner">
        ...
        <div style="margin-top:22px; display:flex; gap:10px;">
            <a href="index.html" style="color:#aaa; text-decoration:none; border:1px solid #333; padding:10px 16px; font-size:12px;">
                WATCHES
            </a>
            <a href="jewelry.html" style="color:#fff; text-decoration:none; border:1px solid #777; background:#111; padding:10px 16px; font-size:12px;">
                JEWELRY
            </a>
        </div>
